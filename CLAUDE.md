...
| `modules/nixos/options/homeserver.nix` | 홈서버 mkOption 정의 (immich, immichBackup, uptime-kuma, anki-sync, anki-connect, copyparty, vaultwarden, karakeep) |
...
| `scripts/` | 자동화 스크립트 (add-host, pre-rebuild-check, fix-fod-hashes) |
...
| Karakeep, 웹 아카이브, web archive, archive.greenhead.dev, 북마크, 아카이빙 | `hosting-karakeep` |
