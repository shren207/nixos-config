...
- 상태 파일(`fallback-processed.tsv`, `fallback-unmatched-notified.tsv`, `fallback-notify-state.tsv`)은 실행 시 GC된다.
  기본 보존값: `*_STATE_RETENTION_DAYS=30`, `NOTIFY_STATE_RETENTION_SEC=86400`
