...
name: hosting-anki
description: |
  Manage Anki sync server and AnkiConnect API on MiniPC homeserver.
  Trigger: 'Anki', 'anki sync', 'AnkiConnect', '카드 덱', '동기화 서버', 'anki 백업', 'headless anki',
  'anki 서비스'.
  NOT for 컨테이너/Podman 일반 관리 (use running-containers).
---
