...
> **참고**: 자세한 트러블슈팅은 `docs/archive/TROUBLESHOOTING.md`의 한글 입력소스 관련 섹션을 참고하세요.
...
> **참고**: 구현 과정에서 발생한 문제와 해결 방법은 `docs/archive/TROUBLESHOOTING.md`의 Hammerspoon 관련 섹션을 참고하세요.
