...
agents_override() {
  ...
  auto_content+="- 상세 direct-Codex wait/write/violation 규칙은 \`modules/shared/programs/claude/files/skills/run-da/SKILL.md\`와 \`.../run-da/references/arbiter-scaling.md\`를 따른다"$'\n'
