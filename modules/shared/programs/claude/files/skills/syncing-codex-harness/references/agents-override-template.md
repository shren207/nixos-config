...
5. Markerless legacy files are not auto-migrated; `sync.sh agents-override` should fail loudly until the file is manually converted to the marker-based format
