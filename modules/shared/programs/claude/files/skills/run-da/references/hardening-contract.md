...
| standard review profile | reviewer/auditor/Intensity spawn의 기본 리뷰 설정 ([`runtime-mapping.md`](runtime-mapping.md) **review profile 매핑** 불릿이 단일 소스) | DA/Intensity spawn 기본값 |
