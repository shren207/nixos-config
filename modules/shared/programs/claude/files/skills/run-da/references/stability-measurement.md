...
| `2:1` | 다수·소수 분리 | `split` | NEEDS_MORE_INFO로 보고, 질문 도구 필수 (런타임별 매핑은 `run-da/SKILL.md`의 "런타임 도구 매핑" 표, 미지원 런타임 대응은 [`arbiter-scaling.md`](arbiter-scaling.md)의 "질문 도구 미지원 대응" 섹션) |
