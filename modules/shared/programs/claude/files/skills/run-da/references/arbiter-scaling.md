...
- 매 실행마다 fresh Arbiter 또는 Intensity subagent 1개를 [run-da canonical contract](../SKILL.md)의 strong review profile로 사용한다.
...
- direct Codex path에서는 fresh intensity subagent 1개를 strong review profile로 사용하고, 결과 파싱 후 completed thread를 `close_agent`로 닫는다.
