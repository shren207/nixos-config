...
> "이슈 등록이 완료되었습니다. 입력에 구현 감사 또는 문서 대비 리뷰 의도가 포함되어 있어, **for_action 모드로 진입 후 Post-Implementation의 5번 Final review** 에서 PRD 10-pass + review-impl overlay (6-classification 라벨링 + overbuilt 우선 분류) 를 적용합니다. 어떻게 진행할까요?"
