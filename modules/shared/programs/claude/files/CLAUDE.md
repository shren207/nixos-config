...
현재 구성: MCP=기존 Chrome autoConnect, AB=독립 Chrome for Testing. 구성 변경 시 재검토.

| 용도 | 권장 도구 | 이유 |
|------|-----------|------|
| 웹 탐색/폼 자동화/스크린샷 | agent-browser | 토큰 2-16x 효율, 속도 4-12x |
...
| 네트워크 인터셉트/HAR 캡처 | agent-browser | route/har 명령 |
