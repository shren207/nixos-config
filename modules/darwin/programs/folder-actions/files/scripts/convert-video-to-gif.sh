...
EXPECTED_STDERR_PATH="$HOME/Library/Logs/folder-actions/convert-video-to-gif.error.log"

LOCK_DIR="/tmp/convert-video-to-gif.lock.d"
LEGACY_LOCK_FILE="/tmp/convert-video-to-gif.lock"
