...
- `skill-noise-check` — shared skill projection staged markdown의 bold / excessive empty lines 잔존 0 검증
- `local-skill-noise-check` — `.claude/skills` staged markdown의 동일 invariant 검증
